...
class _ApiService implements ApiService {
  ...
  @override
  Future<List<UserModel>> findByEmail(String email) async {
  ...
  @override
  Future<ChatModel> createChat(Map<String, dynamic> chat) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<List<ChatMessageResponseItem>> searchMessageInChat(
    ...
    final _options = _setStreamType<List<ChatMessageResponseItem>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'message/chat/${chatId}/messages/search',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<dynamic> getPresence(PresenceRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
